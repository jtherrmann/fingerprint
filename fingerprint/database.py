...
class JavaScriptFingerprint(Base):
    ...
    js_screen_available_height = Column(String)
    js_screen_available_left = Column(String)
    js_screen_available_top = Column(String)
    js_screen_available_width = Column(String)
    js_screen_color_depth = Column(String)
    js_screen_height = Column(String)
    js_screen_left = Column(String)
    js_screen_pixel_depth = Column(String)
    js_screen_top = Column(String)
    js_screen_width = Column(String)
    js_timezone_offset = Column(String)
    js_vendor = Column(String)
    js_vendor_sub = Column(String)
    js_web_driver = Column(String)
    js_canvas_hash = Column(String)
    ...
    js_webgl_unmasked_renderer = Column(String)
